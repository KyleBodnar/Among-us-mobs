...
public class ItemRegister {
    ...
    public static final AmogusTotem AMOGUS_TOTEM = new AmogusTotem(new FabricItemSettings().group(ItemGroup.MISC).fireproof().rarity(Rarity.EPIC));
    public static final Item AMOGIUM_RAW = new Item(new FabricItemSettings().group(ItemGroup.MATERIALS));
    public static final Item AMOGIUM_INGOT = new Item(new FabricItemSettings().group(ItemGroup.MATERIALS));

    public static void registerItems() {
        Registry.register(Registry.ITEM, new Identifier(Amogus.MOD_ID, "keycard"), KEYCARD);
        Registry.register(Registry.ITEM, new Identifier(Amogus.MOD_ID, "amogium_ore"), new BlockItem(BlockRegister.AMOGIUM_ORE, new FabricItemSettings().group(ItemGroup.MISC)));
